...
export default defineConfig({
    ...
    plugins: [circularDependency({ circleImportThrowErr: true }), ptolemyPlugin({ projectName: '@serpentis/ptolemy-example', roots: [__dirname] }),
    ...
    optimizeDeps: {
        exclude: [
            ...
            '@serpentis/ptolemy-arktype-modeling'
        ]
    }
});