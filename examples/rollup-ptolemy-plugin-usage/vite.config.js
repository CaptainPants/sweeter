...
export default defineConfig({
    ...
    plugins: [dts({ clearPureImport: false }), nodeExternals(), circularDependency({ circleImportThrowErr: true }), ptolemyPlugin({ projectName: '@serpentis/ptolemy-rollup-plugin-usage', roots: [__dirname] }),
