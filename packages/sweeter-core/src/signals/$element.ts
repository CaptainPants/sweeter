import { CalculatedSignal, MutableCalculatedSignal } from './internal/Signal-implementations.js';
 ...
 */
export function $element<TSource extends readonly unknown[], TKeyOrIndex extends keyof TSource & (number)>(
 ...
 * @param readonly The derived signal must be readonly - Defaults to false
 */
export function $element<TSource extends readonly unknown[], TKey extends keyof TSource & (number)>(
...
export function $element<TSource extends readonly unknown[], TKeyOrIndex extends keyof TSource>(
    source: Signal<TSource>,
    key: TKeyOrIndex,
