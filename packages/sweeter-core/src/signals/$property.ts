 ...
 */
export function $property<TSource, TKeyOrIndex extends keyof TSource & (string | symbol)>(
 ...
 * @param readonly The derived signal must be readonly - Defaults to false
 */
export function $property<TSource, TKey extends keyof TSource & (string | symbol)>(
...
export function $property<TSource, TKeyOrIndex extends keyof TSource>(
    source: Signal<TSource>,
    key: TKeyOrIndex,
            ...
            (value) => {
                const sourceValue = source.value;
                 ...
                 if (
                    ...
                    throw new TypeError(
                        `Unexpected type ${(sourceValue == null ? 'null ' : typeof sourceValue)}`,
                    );
                }
            },
        );
