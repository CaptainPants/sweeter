import { $calc, $val, type Component, type PropertiesMightBeSignals, type ContextType } from "@captainpants/sweeter-core"
...
export const IconButton: Component<IconButtonProps> = ({ text, icon, onClick }, init) => {
    ...
    return $calc(
        () => {
            ...
            return <Button class={css.addButton} onclick={onClick} outline>
                <Icon />
                <div>{text}</div>
            </Button>;
        }
