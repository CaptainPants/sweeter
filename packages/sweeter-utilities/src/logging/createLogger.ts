...
export function createLogger(codeLocation: CodeLocation, category: string | Function): Logger;
export function createLogger(namespace: string | CodeLocation, category: string | Function): Logger {
    let name: string;
