...
test('test', async () => {
    ...
    const numType1 = z.number().withLabel('2');
    const numType2 = z.number().withLabel('1');
    const numType3 = z.number().withLabel('3');
