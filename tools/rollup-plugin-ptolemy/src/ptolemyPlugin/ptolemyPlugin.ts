...
export interface PtolemyRollupPluginOptions {
...
function ptolemyPlugin({
    ...
    projectName,
    debugMatching,
}: PtolemyRollupPluginOptions): RollupPlugin {
...
export default ptolemyPlugin;
export { ptolemyPlugin };
